<template>
  <div class="courseContainer">
      ...
      <div class="info-container">
        <ul class="route">
          ...
          <li
            ...
            @click="goCourseSearch(courseInfoArr.discountPrice === 0 ? 1 : 2)"
          >
            {{ courseInfoArr.discountPrice === 0 ? "免费课" : "会员课程" }}
          </li>
          <li class="route-item"><i class="el-icon-arrow-right"></i></li>
        ...
        <div class="info">
          ...
          <ul class="access">
            ...
            <li class="access-item">
              {{ courseInfoArr.purchaseCounter + courseInfoArr.purchaseCnt }}人
            </li>
            <li class="access-item">·</li>
    ...
    <div class="info-nav">
      <div class="nav-container">
        ...
        <div
          class="chapter-item"
          @click="change2"
          :id="'downloadAttachment_' + downloadIndex"
        >
    ...
    <div class="course" v-if="activeChange === 1">
      <div class="main">
        <div class="introduction">
          ...
          <div class="btn">
            <button class="btn-item active" @click="goOrder(courseInfoArr)">
              立即购买
            </button>
      ...
      <div v-if="downsource && downsource.length > 0" style="min-height: 500px">
        <div class="down" v-for="(x, y) in downsource" :key="y">
          <div class="source">
            ...
            <button class="downloadbtn" @click="downloadSource(x)">
              下载资料
            </button>
          </div>
        </div>
    ...
    <div
      class="download-icon"
      v-if="downloadMap && downloadMap.size > 0"
    ...
    <el-dialog title="下载详情" :visible.sync="downloadDialog" width="500px">
      <div class="download">
        <el-table
          :data="Array.from(downloadMap.values())"
          style="width: 100%"
          border
          stripe
        >

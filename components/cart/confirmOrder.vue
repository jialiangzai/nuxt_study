    ...
    methods:{
      ...
      paySuccess(){
        if(this.payment.code === 'alipayment'){
          this.$queryOrderWithAli({orderNumber: this.orderNumber}).then(res => {
          ...
          this.$queryOrderWithWX({orderNumber: this.orderNumber}).then(res => {
            if(res.meta.code === "200"){
              clearInterval(this.timeInterVal)
              this.$router.push('/paySuccess')
            }else{
      ...
      payFail(){
        ...
        removeShopCartCourses(){
            ...
            this.$createToken().then(res => {
                ...
                this.$deleteShopCars(this.ids,this.token)
            })
        },
        toPayment(){
        ...
        order(){
            ...
            this.$settlement(this.setArr).then(res => {

        ...
        <ul class="courseUl">
          <li class="goodBook" v-for="i in 4" :key="i">
            <div class="goodBookInfo">
              ...
              <div class="courseName">小鹿线，WEB前端开发书籍待上线...</div>
            </div>
          </li>
        </ul>
      </div>
...
// import { getImageByCode } from '@/api/picture.js'
...
export default {
  ...
  methods: {
    ...
    // //获取最新课程
    // getNewCourse () {
    //   this.$getNewCourse(this.querynew).then(res => {
    ...
    // //获取推荐好课
    // getHotCourse () {
    //   this.$getHotCourse(this.queryhot).then(res => {
    //     if (res.meta.code = '200') {
